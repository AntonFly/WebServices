package org.example;/* Copyright 2001-2010 The Apache Software Foundation.
        *
...
public class SimplePublishPortable {
         ...
         * with this code)
         */
        public void publish(String businessName, String serviceName, String serviceLocation) {
                try {
                        ...
                        accessPoint.setValue(serviceLocation);
